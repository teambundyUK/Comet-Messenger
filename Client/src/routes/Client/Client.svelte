<script>
    ...
    let inbox = [{type:"text", senderID: "Server", senderColor: "red", message: "Welcome to the chat room!"}];
            ...
            <div class="modal">
                ...
                <div class="input-wrapper">
                    <div style="background-color: { color };" class="icon-wrapper">
                        <span style="color: #2a2a2a;" class="material-symbols-rounded icon">
                            palette
                        </span>
                    </div>
                    
                    <input type="color" style="background-color: { color };" class="color-picker" placeholder="Username" bind:value={ color }>
                </div>
