...
io.on('connection', socket => {
    ...
    socket.broadcast.emit('distribute-message', { type: 'connect', senderID: socket.username })
    ...
    socket.on('sent-message', message => {
        ...
        socket.broadcast.emit('distribute-message', { type:"text", senderID: socket.username, senderColor: socket.color, message: message })
    })
    ...
    socket.on('disconnect', () => {
        ...
        socket.broadcast.emit('distribute-message', { type: "disconnect", senderID: socket.username})
    })
})